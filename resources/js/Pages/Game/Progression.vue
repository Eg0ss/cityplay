        ...
        <template #header>
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div class="space-y-1">
                    ...
                    <h1 class="text-3xl lg:text-5xl font-black uppercase italic tracking-tighter flex items-center gap-2">
                        Ma <span class="text-[#87d74e]">Progression</span>
                        <TrendingUp :size="32" class="text-[#87d74e]" />
                    </h1>
                </div>
                <div class="flex items-center gap-3">
                    <Link :href="route('game.setup')" class="btn-3d btn-3d-green px-6 py-4 rounded-xl text-xs font-black uppercase tracking-widest shadow-[0_4px_0_#5d9933] flex items-center gap-2">
                        <Rocket :size="16" />
                        Lancer une partie
                    </Link>
                </div>
        ...
        <div class="space-y-12">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
                ...
                <div class="panel-glass p-5 border border-[#2a245c] relative overflow-hidden group hover:border-[#87d74e]/50 transition-colors">
                    <div class="flex items-center justify-between mb-4">
                        <Search :size="32" class="text-[#87d74e]" />
            ...
            <div class="space-y-6">
                <div class="space-y-1">
                    <h3 class="text-xl font-black uppercase italic tracking-tighter text-[#ffc628] flex items-center gap-2">
                        <Trophy :size="24" class="text-[#ffc628]" />
                        Succès & Badges d'Explorateur
                    </h3>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    <div v-for="badge in badges" :key="badge.id"
                        ...
                        <div class="text-center space-y-4">
                            <div class="h-16 w-16 mx-auto rounded-full bg-[#10101c] border-2 flex items-center justify-center transition-transform duration-500"
                                 :class="[
                                ...
                                <component :is="badge.unlocked ? Award : Crown" :size="28" :class="badge.unlocked ? 'text-[#87d74e]' : 'text-gray-500'" />
                            </div>
                            ...
                            <span class="inline-flex items-center gap-1 text-[8px] font-black uppercase tracking-widest py-1.5 px-4 rounded-full"
                                  :class="badge.unlocked ? 'bg-[#87d74e]/20 text-[#87d74e]' : 'bg-[#1c183a] text-gray-500'">
                                <component :is="badge.unlocked ? Award : Crown" :size="12" />
            ...
            <div class="space-y-6">
                <div class="space-y-1">
                    <h3 class="text-xl font-black uppercase italic tracking-tighter text-[#7751de] flex items-center gap-2">
                        <Map :size="24" class="text-[#7751de]" />
                        Chronologie des Décryptages
                    </h3>
                            ...
                            <tbody>
                                <tr v-for="attempt in recentAttempts" :key="attempt.id"
                                    ...
                                    <td class="py-4.5 px-6 text-center">
                                        <span class="inline-flex items-center gap-1 text-[8px] font-black uppercase tracking-widest py-1 px-3.5 rounded-full"
                                            ...
                                            <component :is="attempt.status === 'gagne' ? CheckCircle2 : XCircle" :size="10" />
                                ...
                                <tr v-if="recentAttempts.length === 0">
                                    <td colspan="5" class="py-12 text-center text-gray-500 uppercase font-black text-xs tracking-widest flex items-center justify-center gap-2">
