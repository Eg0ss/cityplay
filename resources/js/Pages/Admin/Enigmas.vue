        ...
        <div class="space-y-8 lg:space-y-12">
            ...
            <div class="flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div class="w-full md:w-auto">
                    ...
                    <h1 class="text-3xl md:text-6xl font-black tracking-tighter uppercase italic leading-none text-[#FF9F1C]">
                        GESTION <span class="text-[#2fc276]">ENIGMES</span>
                    </h1>
                    <p class="text-gray-500 font-bold uppercase tracking-[0.2em] text-[8px] md:text-[10px] mt-2 md:mt-4 flex items-center gap-2">
            ...
            <transition name="gaming-slide">
                <div v-if="showForm" class="dark:bg-[#1c183a] bg-white p-6 lg:p-12 rounded-[2.5rem] border dark:border-white/10 border-gray-200 shadow-2xl relative overflow-hidden">
                    ...
                    <div class="absolute top-0 left-0 w-full h-1.5 bg-gray-100 dark:bg-white/10 overflow-hidden">
                        ...
                        <transition name="step-fade" mode="out-in">
                            ...
                            <div v-if="currentStep === 1" key="step1" class="space-y-6 md:space-y-8 py-2 md:py-4">
                                <div class="space-y-2">
                                    ...
                                    <h3 class="text-2xl md:text-3xl font-black uppercase italic tracking-tighter dark:text-white">NIVEAU D'<span class="text-[#FF9F1C]">ÉNERGIE</span></h3>
                                </div>
                                <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 md:gap-4">
                                    <button v-for="n in [1,2,3]" :key="n" type="button" @click="form.niveau = n"
                                        :class="[
                                            form.niveau === n ? (n===1 ? 'bg-blue-500 text-black' : n===2 ? 'bg-yellow-500 text-black' : 'bg-red-500 text-black shadow-[0_0_30px_rgba(239,68,68,0.3)]') : 'dark:bg-[#10101c]/60 bg-gray-50 border dark:border-white/5 border-gray-200 text-gray-500'
                                        ]"
                            ...
                            <div v-else-if="currentStep === 2" key="step2" class="space-y-6 md:space-y-8 py-2 md:py-4">
                                <div class="space-y-2">
                                    ...
                                    <h3 class="text-2xl md:text-3xl font-black uppercase italic tracking-tighter dark:text-white">CODE DE <span class="text-[#FF9F1C]">VALIDATION</span></h3>
                                </div>
                                <div class="space-y-3 md:space-y-4">
                                    <label class="block text-[8px] md:text-[10px] font-black uppercase tracking-[0.2em] dark:text-gray-400 text-gray-500 ms-2">La réponse exacte à l'énigme</label>
                                    <input v-model="form.reponse" type="text" autofocus
                                        class="w-full text-xl md:text-4xl dark:bg-[#10101c]/60 bg-gray-50 border-none rounded-2xl md:rounded-3xl py-6 md:py-8 px-6 md:px-8 focus:ring-4 focus:ring-[#FF9F1C]/20 dark:text-white text-gray-900 font-black italic tracking-tighter placeholder:opacity-20" 
                                        placeholder="EX: PLACE DES MARTYRS" />
                                </div>
                                <div class="flex flex-col sm:flex-row gap-3 md:gap-4">
                                    <button @click="prevStep" class="w-full sm:w-auto px-8 py-5 md:py-6 rounded-xl md:rounded-2xl border-2 dark:border-white/10 border-gray-200 font-black uppercase tracking-widest text-[10px] md:text-xs dark:text-white hover:bg-white hover:text-black transition-all">RETOUR</button>
                            ...
                            <div v-else-if="currentStep === 3" key="step3" class="space-y-6 md:space-y-8 py-2 md:py-4">
                                <div class="space-y-2">
                                    ...
                                    <h3 class="text-2xl md:text-3xl font-black uppercase italic tracking-tighter dark:text-white">SÉQUENCE <span class="text-[#FF9F1C]">NARRATIVE</span></h3>
                                </div>
                                <div class="space-y-6">
                                    <!-- Texte de l'énigme -->
                                    <div class="space-y-2 md:space-y-3">
                                        <label class="block text-[8px] md:text-[10px] font-black uppercase tracking-[0.2em] dark:text-gray-400 text-gray-500 ms-2">Le texte de l'indice</label>
                                        <textarea v-model="form.description" rows="5" autofocus
                                            class="w-full text-lg md:text-xl dark:bg-[#10101c]/60 bg-gray-50 border-none rounded-2xl md:rounded-3xl py-5 md:py-6 px-6 md:px-8 focus:ring-4 focus:ring-[#FF9F1C]/20 dark:text-white text-gray-900 font-bold italic tracking-tight placeholder:opacity-20" 
                                    ...
                                    <div v-if="form.niveau < 3" class="space-y-3 md:space-y-4">
                                        <label class="block text-[8px] md:text-[10px] font-black uppercase tracking-[0.2em] dark:text-gray-400 text-gray-500 ms-2">Propositions de Réponses (Fausse pistes)</label>
                                        <div class="grid gap-3 md:gap-4 sm:grid-cols-2">
                                            <div v-for="(opt, index) in form.mcq_options" :key="index" class="relative group">
                                                ...
                                                <input v-model="form.mcq_options[index]" type="text" 
                                                    class="w-full dark:bg-[#10101c]/60 bg-gray-50 border-none rounded-xl md:rounded-2xl py-4 md:py-5 pl-10 md:pl-12 pr-4 md:pr-6 focus:ring-2 focus:ring-[#FF9F1C]/30 text-[10px] md:text-xs dark:text-white text-gray-900 font-bold uppercase tracking-widest" 
                            ...
                            <div v-else-if="currentStep === 4" key="step4" class="space-y-6 md:space-y-8 py-2 md:py-4">
                                <div class="space-y-2">
                                    ...
                                    <h3 class="text-2xl md:text-3xl font-black uppercase italic tracking-tighter dark:text-white">PROTOCOLE D'<span class="text-[#FF9F1C]">INDICES</span></h3>
                                </div>

                                <div class="space-y-8">
                                    <!-- Indice Images (Multiples) -->
                                    <div class="space-y-4">
                                        <label class="block text-[8px] md:text-[10px] font-black uppercase tracking-[0.2em] dark:text-gray-400 text-gray-500 ms-2">Images d'indice (Multiples)</label>
                                        <div class="relative group min-h-[150px]">
                                            <input type="file" multiple @change="onHintImagesChange" 
                                                class="absolute inset-0 opacity-0 cursor-pointer z-20" />
                                            <div class="min-h-[150px] dark:bg-[#10101c]/60 bg-gray-50 border-2 border-dashed dark:border-white/10 border-gray-200 rounded-3xl flex flex-col items-center justify-center p-6 group-hover:border-[#FF9F1C]/50 transition-all overflow-hidden relative">
                                    ...
                                    <!-- Mot-clé d'indice -->
                                    <div class="space-y-3 md:space-y-4">
                                        <label class="block text-[8px] md:text-[10px] font-black uppercase tracking-wide dark:text-gray-400 text-gray-500 ms-2">Mot-clé d'indice (Optionnel)</label>
                                        <input v-model="form.hint_keyword" type="text"
                                            class="w-full text-lg dark:bg-[#10101c]/60 bg-gray-50 border-none rounded-2xl py-5 px-6 md:px-8 focus:ring-4 focus:ring-[#FF9F1C]/20 dark:text-white text-gray-900 font-bold italic tracking-tight placeholder:opacity-20" 
                    ...
                    <div class="absolute bottom-4 left-8 text-[8px] font-black text-gray-500 uppercase tracking-[0.4em]">Etape {{ currentStep }} / 04</div>
                </div>
            </transition>
                ...
                <div v-for="level in [3, 2, 1]" :key="level" class="space-y-6">
                    ...
                    <div class="grid gap-4 md:gap-6 md:grid-cols-2">
                        <div v-for="enigma in enigmas.filter(e => e.niveau === level)" :key="enigma.id" 
                            class="dark:bg-[#1c183a]/40 bg-white border dark:border-white/10 border-gray-200 p-5 md:p-8 rounded-[2rem] md:rounded-[2.5rem] group hover:border-[#FF9F1C]/40 transition-all duration-500 shadow-xl flex flex-col justify-between">
                            <div>
                            ...
                            <div class="flex items-center justify-between pt-6 md:pt-8 border-t dark:border-white/10 border-gray-100">
                                <div class="space-y-1">
                                    <p class="text-[7px] md:text-[8px] font-black uppercase dark:text-gray-400 text-gray-500 tracking-widest">CODE DE VALIDATION</p>
                                ...
                                <div v-if="enigma.mcq_options && enigma.mcq_options.length > 0" class="flex -space-x-2 md:-space-x-3">
                                    <div v-for="opt in 4" :key="opt" class="h-6 w-6 md:h-8 md:w-8 rounded-lg md:rounded-xl dark:bg-black/60 bg-gray-100 border-2 dark:border-[#1c183a] border-white flex items-center justify-center text-[8px] md:text-[10px] font-black text-gray-500 group-hover:border-[#FF9F1C]/30 transition-all">
                                        {{ opt }}
                                    </div>
                                </div>
                            </div>
                        ...
                        <div v-if="enigmas.filter(e => e.niveau === level).length === 0" 
                            class="md:col-span-2 py-10 md:py-16 text-center border-4 border-dashed dark:border-white/10 border-gray-100 rounded-[2rem] md:rounded-[3rem] flex flex-col items-center justify-center opacity-20">
